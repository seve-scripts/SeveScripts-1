...
echo " To Start: ./command.sh start"
echo " To Stop: ./command.sh stop" 
echo " To Uninstall Script: ./command.sh uninstall" 
echo " Info: ./command.sh info" 
...
case $yn in
[Yy]* ) sudo apt-get purge --auto-remove ziproxy && rm nossh.sh; break;; 
[Nn]* ) exit;; 
...
ziproxy -d 
clear 
echo "The No SSH is Successfully Started!!" 
echo "ENJOY!"
echo
}
# Yamete Kudasai
...
ziproxy -k 
clear 
echo "The No SSH is Successfully Stopped!!"
echo 
}
# Info Print
info(){ 
